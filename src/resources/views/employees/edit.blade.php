                    ...
                    >
                        ...
                        <div class="mb-4">
                            ...
                            >
                                ...
                                <option
                                    value="Male"
                                    {{ old('gender', $employee->gender?->value ?? $employee->gender) === 'Male' ? 'selected' : '' }}
                                >
                                    Male
                                </option>
                                ...
                                <option
                                    value="Female"
                                    {{ old('gender', $employee->gender?->value ?? $employee->gender) === 'Female' ? 'selected' : '' }}
                                >
                                    Female
                                </option>
                            </select>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    name="monthly_salary"
                                    id="monthly_salary"
                                    value="{{ old('monthly_salary', number_format((float) $employee->monthly_salary, 2, '.', ',')) }}"
                                    required
                                    inputmode="decimal"
                                    placeholder="0.00"
